...
public final class GuideBookManager {
    ...
    public static final String NORMAL_NPC_PLAYER_CODEX = "normalnpcplayer:normal_npc_player_codex";
    ...
    public static ItemStack createNormalNPCPlayerCodex() { return createPatchouliGuideBook(NORMAL_NPC_PLAYER_CODEX); }
    ...
    public static void giveAtBirth(ServerPlayer player) {
        ...
        giveOrDrop(player, createNormalNPCPlayerCodex());
    }
