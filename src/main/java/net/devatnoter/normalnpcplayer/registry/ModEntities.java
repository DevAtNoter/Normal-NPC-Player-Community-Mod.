...
public final class ModEntities {
    ...
    public static final RegistryObject<EntityType<GrowthChildPlayerMobEntity>> GROWTH_CHILD_PLAYER_MOB =
            ENTITY_TYPES.register(
                    "growth_child_player_mob",
                    () -> EntityType.Builder
                            .<GrowthChildPlayerMobEntity>of(
                                    GrowthChildPlayerMobEntity::new,
                                    MobCategory.CREATURE
                            )
                            .sized(0.6F, 1.8F)
                            .clientTrackingRange(8)
                            .updateInterval(3)
                            .build("growth_child_player_mob")
            );

    public static final RegistryObject<EntityType<GrowthChildHardcorePlayerMobEntity>> GROWTH_CHILD_HARDCORE_PLAYER_MOB =
            ENTITY_TYPES.register(
                    "growth_child_hardcore_player_mob",
                    () -> EntityType.Builder
                            .<GrowthChildHardcorePlayerMobEntity>of(
                                    GrowthChildHardcorePlayerMobEntity::new,
                                    MobCategory.CREATURE
                            )
                            .sized(0.6F, 1.8F)
                            .clientTrackingRange(8)
                            .updateInterval(3)
                            .build("growth_child_hardcore_player_mob")
            );
