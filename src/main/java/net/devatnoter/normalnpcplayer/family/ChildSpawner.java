...
public final class ChildSpawner {
    ...
    public static BabyNPCPlayerEntity spawn(ServerPlayer player) {
        ...
        // Give-at-birth is a distribution mode, not a game-mode restriction.
        // The first Player Baby is a real birth path as well, so it must receive
        // the complete Patchouli guide set when that mode is selected.
        GuideBookManager.giveAtBirth(player);
