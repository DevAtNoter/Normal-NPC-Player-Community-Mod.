...
public final class BabyItemRenderState {
    ...
    /**
     * Advances renderer-owned time. The renderer proxy is not part of the
     * client level tick loop, so this clock keeps GeckoLib animations alive
     * without mutating gameplay NBT.
     */
