...
public final class ModParticles {
    ...
    public static final RegistryObject<SimpleParticleType> TOTEM_OF_BABY_COMBAT_EMITTER =
            PARTICLE_TYPES.register("totem_of_baby_combat_emitter", () -> new SimpleParticleType(false));
