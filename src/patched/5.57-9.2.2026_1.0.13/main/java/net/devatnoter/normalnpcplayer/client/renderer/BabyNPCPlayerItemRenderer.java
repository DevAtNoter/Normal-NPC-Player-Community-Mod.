...
public final class BabyNPCPlayerItemRenderer
    ...
    public void renderByItem(
        ...
        // not receive Entity.tick(). GeckoLib still needs a monotonically
        // advancing entity clock for its animation state. Advance only the
        // render proxy here; this never changes gameplay/ItemStack state.
        renderState.advanceRenderFrame();
        baby.tickCount = (int) Math.min(2_000_000_000L, renderState.renderFrames());
