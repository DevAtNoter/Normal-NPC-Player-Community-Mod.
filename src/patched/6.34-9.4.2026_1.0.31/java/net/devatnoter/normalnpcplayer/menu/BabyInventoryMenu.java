...
public final class BabyInventoryMenu extends AbstractContainerMenu {
    ...
    public void clicked(int slotId, int button, net.minecraft.world.inventory.ClickType clickType, Player player) {
         ...
         * This explicit guard covers normal clicks, drag placement and other
         * container click paths before vanilla slot handling can mutate the
         * carrier. The Baby remains in the player's cursor/inventory.
         */
    ...
    private final class EquipmentSlotView extends Slot {
        ...
        @Override public Pair<ResourceLocation, ResourceLocation> getNoItemIcon() {
            ResourceLocation sprite = switch (equipmentSlot) {
                ...
                case MAINHAND -> new ResourceLocation("minecraft", "item/empty_slot_sword");
                default -> null;
            };
    ...
    private static final class BabyEquipmentContainer implements Container {
        ...
        @Override public void setItem(int index, ItemStack stack) {
            ...
            else if (data != null) BabyEquipmentLogic.write(
