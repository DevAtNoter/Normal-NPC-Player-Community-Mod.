...
public final class ClientEvents {
    ...
    public static void onCarriedBabyEquipmentClick(ScreenEvent.MouseButtonPressed.Pre event) {
        ...
        if (button == 0 && !control && carried.getItem() instanceof ElytraItem) {
            target = EquipmentSlot.CHEST;
        } else if (button == 0 && !control && carried.getItem() instanceof ArmorItem armor) {
