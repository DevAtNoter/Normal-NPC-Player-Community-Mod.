...
public final class BabyNPCPlayerItemEvents {
    ...
    public static void onBabyRightClick(
        ...
        // Picking the Baby up into the carrier item also clears the explicit
        // player-commanded combat target. The next placement starts clean.
        net.devatnoter.normalnpcplayer.equipment.BabyCombatController.clearPlayerCommandTarget(baby);
