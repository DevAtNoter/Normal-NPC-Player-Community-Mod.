...
public final class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> BABY_SCREAM =
            register("baby.scream");

    public static final RegistryObject<SoundEvent> BABY_HURT =
            register("baby.hurt");

    public static final RegistryObject<SoundEvent> BABY_SUFFER =
            register("baby.suffer");

    public static final RegistryObject<SoundEvent> BABY_DEAD =
            register("baby.dead");
