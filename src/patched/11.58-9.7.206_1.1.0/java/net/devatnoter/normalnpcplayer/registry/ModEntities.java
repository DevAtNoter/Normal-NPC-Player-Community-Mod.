...
public final class ModEntities {
    ...
    public static final RegistryObject<EntityType<TruePlayerFamilyAdultPlayerMobEntity>> TRUE_PLAYER_FAMILY_ADULT =
            ENTITY_TYPES.register(
                    "true_player_family_adult",
                    () -> EntityType.Builder
                            .<TruePlayerFamilyAdultPlayerMobEntity>of(
                                    TruePlayerFamilyAdultPlayerMobEntity::new,
                                    MobCategory.CREATURE
                            )
                            .sized(0.6F, 1.8F)
                            .clientTrackingRange(8)
                            .updateInterval(3)
                            .build("true_player_family_adult")
            );

    public static final RegistryObject<EntityType<TruePlayerHarcoreChildAdult>> TRUE_PLAYER_HARCORE_CHILD_ADULT =
            ENTITY_TYPES.register(
                    "true_player_harcore_child_adult",
                    () -> EntityType.Builder
                            .<TruePlayerHarcoreChildAdult>of(
                                    TruePlayerHarcoreChildAdult::new,
                                    MobCategory.CREATURE
                            )
                            .sized(0.6F, 1.8F)
                            .clientTrackingRange(8)
                            .updateInterval(3)
                            .build("true_player_harcore_child_adult")
            );
